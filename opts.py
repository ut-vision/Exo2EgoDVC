...
def parse_opts():
    ...
    parser.add_argument('--grad_reverse', default='true', choices=['true', 'false'], help='if use grad reverse for pdvc-view')
    ...
    # parser.add_argument('--dataset_type', type=str, default='none', choices=['none', 'full', 'sub'])
    ...
    parser.add_argument('--pretrain', type=str, choices=['full', 'encoder', 'decoder'], default='full')
    ...
    parser.add_argument('--src_pretrain_epoch', default=0, type=float)
    parser.add_argument('--src_loss_coef', default=0.1, type=float)
    parser.add_argument('--view_loss_coef', default=0.1, type=float)
    parser.add_argument('--view_grl_coef', default=1, type=float)
    ...
    parser.add_argument('--frame_embedding_num', type=int, default = 200)
    ...
    parser.add_argument('--adapt_loss_type', default='adv', choices=['adv', 'mmd'])
    ...
    #***************************** Event counter *****************************
    parser.add_argument('--max_eseq_length', default=20, type=int)
