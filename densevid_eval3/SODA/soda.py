...
# adapted from https://github.com/awkrail/jesg/blob/f97dc6b36e3bc2b7945c23315f8e10921b524d29/densevid_eval3/SODA/soda.py
...
if __name__ == '__main__':
    ...
    parser.add_argument('-v', '--verbose', action='store_true',
                        help='print details')
    parser.add_argument('-ot', '--output', type=str, help='output path to directory')
